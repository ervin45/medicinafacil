...
public class FormularioDoctor extends JFrame {
	...
	private JPanel getPanelDoctor() {
		if (panelDoctor == null) {
			...
			panelDoctor.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.black, 1), "Agregar Doctor Doctor", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, new Font("Dialog", Font.BOLD, 12), new Color(51, 51, 51)));
